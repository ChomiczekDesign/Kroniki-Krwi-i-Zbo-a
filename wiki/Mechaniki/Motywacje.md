...
Motywacje opisują najważniejsze wewnętrzne siły napędowe postaci: jej cele, obawy, mocne strony oraz słabości. Pomagają w odgrywaniu bohatera, dostarczają MG haków fabularnych i mają znaczenie w scenach społecznych.
...
Na potrzeby talentów test **Poznawania Motywacji** traktowany jest jako **Knowledge Check**.
